...
public class BoxAreaDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUILayout.PropertyField(property.FindPropertyRelative("absoluteshiftX"), new GUIContent("Horizontal shift"));
        EditorGUILayout.PropertyField(property.FindPropertyRelative("absoluteshiftY"), new GUIContent("Floor Height"));
        EditorGUILayout.PropertyField(property.FindPropertyRelative("absoluteshiftZ"), new GUIContent("distance from the front wall"));
