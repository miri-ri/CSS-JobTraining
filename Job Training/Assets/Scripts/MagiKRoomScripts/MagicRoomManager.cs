...
public class MagicRoomManager : MonoBehaviour
{
    ...
    public MagicRoomClimbingWallManager MagicRoomClimbingWallManager
    {
        get;
        private set;
    }
    ...
    private void InitComponent()
    {
        ...
        if (ClimbingWall)
        {
            MagicRoomClimbingWallManager = gameObject.AddComponent<MagicRoomClimbingWallManager>();
        }
...
public class SystemConfiguration
{
    ...
    public float floorSizeZ = 2.88f;
    public float floorOffsetX = 0;
    public float floorOffsetY = 0;
    public float floorOffsetZ = 0;
